...
function(setversionfromgit)
    if(Git_FOUND)
        ...
        execute_process(
            ...
            if(GIT_DESCRIBE_ERROR_CODE OR NOT GIT_DESCRIBE_VERSION)
                message(WARNING "git describe failed, using default version 0.1.0")
                set(PROJECT_VERSION_MAJOR 0 PARENT_SCOPE)
                set(PROJECT_VERSION_MINOR 1 PARENT_SCOPE)
                set(CMAKE_PROJECT_VERSION 0.1.0 PARENT_SCOPE)
                return()
            endif()
